...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    //Главный метод — onMessageReceived вызывается каждый раз, когда приходит уведомление
    //и приложение открыто. С его помощью проверяем, пришли ли какие-то данные в уведомлении.
